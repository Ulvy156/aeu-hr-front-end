...
<template>
  <div>
    <div class="relative">
      ...
      <el-table :data="positions" class="w-full">
        ...
        <el-table-column label="Actions" width="100" fixed="right" align="center">
          <template #default="{ row }">
            <div class="flex items-center justify-center gap-1">
              <el-tooltip v-if="can('positions.update')" content="Edit" placement="top">
                <button
              ...
              <el-tooltip v-if="can('positions.delete')" content="Delete" placement="top">
                <button
